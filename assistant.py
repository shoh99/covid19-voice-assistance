...
API_KEY = 't7sbEJssWGTp'
PROJECT_TOKEN = 'ts-iNeuSttd0'
RUN_TOKEN = 'tiKK5hLV2dOc'
        ...
        def poll():
            ...
            while True:
                ...
                if new_data != old_data:
                    self.data = new_data
                    print('Data succsesfully updated')
                    break
...
def main():
    ...
    TOTAL_PATTERNS = {
        re.compile('[\w\s]+ total [\w\s]+ cases'):data.get_total_casess,
        re.compile('[\w\s]+ total cases'): data.get_total_casess,
